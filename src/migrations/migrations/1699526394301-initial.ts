...
export class Initial1699526394301 implements MigrationInterface {
    name = 'Initial1699526394301'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "notifications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), "deletedAt" TIMESTAMP, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "topic" character varying NOT NULL, "username" character varying NOT NULL, "title" character varying NOT NULL, "content" character varying NOT NULL, "notificationType" character varying NOT NULL, "notificationStatus" character varying NOT NULL, "notificationProgress" character varying NOT NULL, "fromUserId" uuid NOT NULL, "toUserId" uuid NOT NULL, CONSTRAINT "PK_6a72c3c0f683f6462415e653c3a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "subscribers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), "deletedAt" TIMESTAMP, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "username" character varying NOT NULL, "token" character varying NOT NULL, "topic" character varying NOT NULL, "subscribed" boolean NOT NULL, CONSTRAINT "PK_cbe0a7a9256c826f403c0236b67" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "friendships" ADD CONSTRAINT "FK_563c8f0d6e66445e58e4fdb6bee" FOREIGN KEY ("fromUserId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "friendships" ADD CONSTRAINT "FK_68ed3fe3cd727012aa82545d0ed" FOREIGN KEY ("toUserId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notifications" ADD CONSTRAINT "FK_3a26cceed2f10be1c5e15f7ef6a" FOREIGN KEY ("fromUserId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "notifications" ADD CONSTRAINT "FK_f1781c52eb2836d840f1c613f09" FOREIGN KEY ("toUserId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "page_follows" ADD CONSTRAINT "FK_a1bb3e598fdc69dd7478c2813de" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "page_follows" ADD CONSTRAINT "FK_f84b1b480f10c248bcc59161ace" FOREIGN KEY ("pageId") REFERENCES "pages"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "group_memberships" ADD CONSTRAINT "FK_ae52b7a8e0e084d7945522ef762" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "group_memberships" ADD CONSTRAINT "FK_a434c0d46f4b97696924ecdd176" FOREIGN KEY ("groupId") REFERENCES "groups"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "page_follows" DROP CONSTRAINT "FK_f84b1b480f10c248bcc59161ace"`);
        await queryRunner.query(`ALTER TABLE "page_follows" DROP CONSTRAINT "FK_a1bb3e598fdc69dd7478c2813de"`);
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_f1781c52eb2836d840f1c613f09"`);
        await queryRunner.query(`ALTER TABLE "notifications" DROP CONSTRAINT "FK_3a26cceed2f10be1c5e15f7ef6a"`);
        await queryRunner.query(`ALTER TABLE "friendships" DROP CONSTRAINT "FK_68ed3fe3cd727012aa82545d0ed"`);
        await queryRunner.query(`ALTER TABLE "friendships" DROP CONSTRAINT "FK_563c8f0d6e66445e58e4fdb6bee"`);
